...
'umNenhumNoMinimo', a função 'larguraCompObstaculos' e a função 'maxTerrenoContiguo', funções que recebem um mapa e retornam um bool e que verificam as restrições anteriormente
enunciadas. 
...
{- |A função 'obstaculoTerrenoProprio', que recebe um mapa e retorna um bool, verifica se num dado mapa não existem obstáculos em terrenos impróprios, ou seja, verifica que não
existem Troncos em Estradas ou Relvas, que não existem Carros em Rios ou Relvas e que não existem Arvores em Rios ou Estradas.
