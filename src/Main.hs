...
A função 'main' é a função que inicia o jogo, contém a lista de bitmaps, cria as primeiras 5 seeds utilizadas no mapa inicial do jogo, e com a função 'playIO' junta todas as restantes peças para executar o jogo.
